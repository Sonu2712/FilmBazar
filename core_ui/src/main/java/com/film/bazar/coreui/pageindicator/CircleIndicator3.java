...
public class CircleIndicator3 extends BaseCircleIndicator {
    ...
    private Integer origPosition = 0;
    ...
    private final ViewPager2.OnPageChangeCallback mInternalPageChangeCallback =
            new ViewPager2.OnPageChangeCallback() {
                ...
                public void onPageScrollStateChanged(int state) {
                    ...
                    if (state == ViewPager.SCROLL_STATE_DRAGGING && !startedScrolling) {
                        startedScrolling = true;
                        if (runnable != null) handler.removeCallbacks(runnable);
                    }
                    if (state == ViewPager.SCROLL_STATE_IDLE && startedScrolling) {
                        startedScrolling = false;
                        startAutoSlider(getItems());
                    }
                }
            };
