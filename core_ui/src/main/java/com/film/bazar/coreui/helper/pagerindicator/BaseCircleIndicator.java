package com.film.bazar.coreui.helper.pagerindicator;
...
class BaseCircleIndicator extends LinearLayout {
    ...
    public void initialize(Config config) {
        ...
        mIndicatorBackgroundResId = R.drawable.bg_selected_dot_indicator;
        mIndicatorUnselectedBackgroundResId = R.drawable.bg_dot_indicator;
