...
import com.film.bazar.flashbar.Flashbar.Gravity.BOTTOM
import com.film.bazar.flashbar.Flashbar.Gravity.TOP
...
class Flashbar private constructor(private var builder: Builder) {
    ...
    class Builder(internal var activity: Activity) {
         ...
         */
        fun dismissOnTapOutside(cancelable: Boolean) = apply {
            this.barDismissOnTapOutside = cancelable
        }

        /*dismiss bar as well as return backPress false*/
        fun isCancelable(cancelable: Boolean) = apply { this.isCancelable = cancelable }
         ...
         */
        fun primaryActionText(actionText: Spanned) =
            apply { this.primaryActionTextSpanned = actionText }

        /**
         * Specifies the primary action text typeface
         */
        fun primaryActionTextTypeface(typeface: Typeface) =
            apply { this.primaryActionTextTypeface = typeface }
         ...
         */
        fun primaryActionTextColor(@ColorInt color: Int) =
            apply { this.primaryActionTextColor = color }
