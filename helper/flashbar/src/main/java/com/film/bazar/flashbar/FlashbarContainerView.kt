package com.film.bazar.flashbar
...
import com.film.bazar.flashbar.Flashbar.Companion.DURATION_INDEFINITE
import com.film.bazar.flashbar.Flashbar.DismissEvent
import com.film.bazar.flashbar.Flashbar.DismissEvent.*
import com.film.bazar.flashbar.Flashbar.Vibration.DISMISS
import com.film.bazar.flashbar.SwipeDismissTouchListener.DismissCallbacks
import com.film.bazar.flashbar.anim.FlashAnim
import com.film.bazar.flashbar.anim.FlashAnimBarBuilder
import com.film.bazar.flashbar.anim.FlashAnimIconBuilder
import com.film.bazar.flashbar.util.NavigationBarPosition.*
import com.film.bazar.flashbar.util.afterMeasured
import com.film.bazar.flashbar.util.getNavigationBarPosition
import com.film.bazar.flashbar.util.getNavigationBarSizeInPx
import com.film.bazar.flashbar.util.getRootView
...
internal class FlashbarContainerView(context: Context) : RelativeLayout(context), DismissCallbacks {
    ...
    internal fun isCancelable(cancelable: Boolean) {
    ...
    private fun dismissInternal(event: DismissEvent) {
        /*Commented to solve bar not dismiss issue*/

        /*if (isBarDismissing || isBarShowing || !isBarShown) {
            Log.d("FlashBar", "Dismiss return called ")
