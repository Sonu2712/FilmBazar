...
import com.film.bazar.coredata.util.interceptors.HeaderInterceptor.Companion.DateHeader
...
class HeaderPlaceOrderInterceptor @Inject constructor(
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        val builder = original.newBuilder().apply {
            ...
            header(DateHeader, GetRequestDate())
